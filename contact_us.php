...
<aside class="w-80 h-screen bg-gray shadow-md w-fulll hidden sm:block">
    <div class="flex flex-col justify-between h-screen p-4 bg-gray-800">
      <div class="text-sm">
        ...
        <a href="contact_us.php" > <div class=" adminactive bg-yellow-500 text-white p-2 rounded mt-2 cursor-pointer hover:bg-gray-700 hover:text-blue-300">Contact Us</div></a>
            ...
            <div class="orders">
               <div class="row">
                  <div class="col-xl-12">
                     <div class="card">
                        <div class="card-body">
                           <h4 class="box-title">Customer Query </h4>
                        </div>
                        <div class="card-body--">
                              ...
                              <table class="min-w-full table-auto text-white">
                                 <thead class="justify-between">
                                    <tr class="bg-gray-800">
                                       ...
                                       <th class="px-10 py-2">Comment</th>
                                       <th class="px-10 py-2">Date</th>
                                       <th class="px-10 py-2">Remove</th>
                                    </tr>
                                 </thead>
							                ...
							                <?php 
							                  ...
							                  while($row=mysqli_fetch_assoc($res)){?>
							                    <tr class="bg-gray-500 border-4 border-gray-200">
                                                    ...
                                                    <td class="px-10 py-2"><?php echo $row['comment']?></td>
                                                    <td class="px-10 py-2"><?php echo $row['added_on']?></td>
							                        <td>
                                                        <?php
                                                        echo "<span class='h-8 px-4 py-2 m-1 text-sm text-indigo-100 transition-colors duration-150 bg-red-500 rounded-lg focus:shadow-outline hover:bg-indigo-800'><a href='?type=delete&id=".$row['id']."'>Delete
