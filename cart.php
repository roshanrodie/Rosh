        ...
        <tbody>
          ...
          <tr class="border-gray-400">
            <td class=" product-thumbnail hidden pb-4 md:table-cell">
              <a href="#">
                <img class="w-20 rounded" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image?>">
              </a>
            </td>
            <td class="product-name">
              <a href="#">
                <p class="mb-2 md:ml-4"><?php echo $pname?></p>
                
              </a>
            </td>
            <td class="product-price justify-center md:justify-end md:flex mt-6">
              <div class="w-20 h-10">
              <p class="mb-2 md:ml-4"><?php echo $price?></p>
            </td>
            <td class="product-quantity hidden text-right md:table-cell">
            <a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','update')">Update</a>
              <span class="text-sm lg:text-base font-medium">
              <input class=" bg-gray-400 w-10 m-2 border-black rounded" type="number" id="<?php echo $key?>qty" value="<?php echo $qty?>"/>
